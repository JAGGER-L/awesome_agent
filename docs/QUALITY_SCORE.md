...
locally. Modifying output is still unvalidated; deterministic validation,
team/subagent runtime, and full observability remain roadmap work.
...
| System tests | 3/5 | PostgreSQL restart, Worker crash/resume, sandbox, worktree, durable approval, and API tests; Team E2E still uses manually constructed state |
