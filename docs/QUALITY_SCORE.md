...
locally with exact-invocation approvals, active cancellation, and validation-
gated modifying completion. Team/subagent runtime and full observability remain
roadmap work.
...
| System tests | 3/5 | PostgreSQL restart, Worker crash/resume, sandbox, worktree, durable approval, active cancellation, validation evidence, and API tests; Team E2E still uses manually constructed state |
